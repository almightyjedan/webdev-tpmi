			...
			<div class="actual-input-container">
				<div class="input-group">
					...
					<div class="input-wrapper">
						<input type="number" id="actHead" class="input-field" placeholder="0" oninput="updatePoint()">
            ...
            function checkAllPumps() {
                ...
                Promise.all([qVisual, qData, qMin]).then(responses => {
                    ...
                    for (let i = 0; i < dtMax.getNumberOfRows(); i++) {
                        ...
                        if (hIn <= (yMax + 0.5) && hIn >= (yMin - 0.5)) {
                            foundCount++;
                            let row = tbody.insertRow();
                            row.innerHTML = `
                                            <td>${i + 1}</td>
                                            <td>${dtVisual.getValue(i, 0)}</td>
                                            <td>${Math.round(dtVisual.getValue(i, 1))}</td>
                                            ...
                                            <td>${Math.round(dtVisual.getValue(i, 7))}</td>
